        ...
        <div style={{ padding: '14px 20px 0' }}>
          ...
          <div style={{ marginTop: 18, marginBottom: 4 }}>
            ...
            {/* Un valore solo, dal registro condiviso byup_valutazione (P-157):
                lo stesso del gestionale e della webapp. Le stelle seguono il numero. */}
              ...
              {stelle.map((st, i) => {
                ...
                return (
                  <div key={n} style={{
                    ...
                    background: st === 'piena' ? PINK_X : st === 'mezza' ? `linear-gradient(90deg, ${PINK_X} 50%, ${TINT_X} 50%)` : TINT_X,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
