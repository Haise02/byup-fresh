...
Azioni una-tantum: completa profilo (+50), primo ordine app (+200), imposta diete/allergeni (+30), attiva notifiche (+20), invita un amico (+300 quando ordina la prima volta).

## Come si spendono
Credito: **100 byuppini = 1€** di sconto (lineare, semplice), con taglio bonus (1.000 → 12€).

Catalogo premi: gadget byup (sticker 150, tote 500, borraccia 800), esperienze presso i locali partner (dessert offerto 400, aperitivo x2 900), e in cima la **byup card cashback** — premio aspirazionale, sbloccabile a LIV.5 / 5.000 byuppini.

Livelli (LIV.1→LIV.5, es. Novizio → Gourmet → Icona): ogni livello dà perk crescenti — moltiplicatore punti, accesso anticipato alle offerte, premi esclusivi. Salire di livello = momento celebrativo (mascotte + confetti).
...
## Marketing
Meccanica collect-and-unlock con feedback dopaminico (numero che sale, mascotte che reagisce, confetti al level-up); sfide settimanali a tempo per creare urgenza e ritorno frequente; referral in byuppini per la crescita virale; leaderboard opzionale tra amici e gruppi (i "gruppi" esistono già nel profilo) per la competizione sociale.

## Schermate
1. **Portafoglio** — saldo grande + mascotte, livello e barra al prossimo, "guadagna oggi", scorciatoia ai premi, attività recente.
2. **Sfide** — missioni attive con progress, sfida dal vivo (QR), streak, timer settimanale.
