...
- `preferences`: `{ allergens{}, diets{} }` (booleani) — allergeni = i **14 del Reg. UE 1169/2011** (glutine, crostacei, uova, pesce, arachidi, soia, lattosio, noci, sedano, senape, sesamo, solfiti, lupini, molluschi); diete = vegetariano, vegano, senzaglutine, halal, kosher, pescetariano, astemio, proteico
