...
const THEMES = {
  ...
  dark: {
    dark: true,
    bg: '#160910', surface: '#241019', surfaceAlt: '#2c1520',
    text: '#fbeae6', textDim: 'rgba(251,234,230,.60)', textFaint: 'rgba(251,234,230,.36)',
    primary: PALETTE.coralHot, onPrimary: '#ffffff',
    accentSoft: 'rgba(255,61,110,.14)', accentBorder: 'rgba(255,61,110,.26)',
    glass: 'rgba(36,16,25,.60)', glassBorder: 'rgba(251,234,230,.12)',
    line: 'rgba(251,234,230,.10)',
    shadow: '0 18px 40px -22px rgba(255,61,110,.38)',
    shadowSoft: '0 10px 28px -16px rgba(0,0,0,.55)',
    glow: 'rgba(255,61,110,.13)',
