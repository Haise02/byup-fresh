...
function ScreenProfilo({ nav, openModal, faceIdOn = false, setFaceIdOn = () => {} }) {
  ...
  return (
    <div style={{ background: ST.BG, minHeight: '100%', paddingBottom: 100 }}>
      ...
      {/* Niente «Ponte di stampa» (P-124 · D-108): il ponte Bluetooth attraverso
          l'App Staff è rinviato oltre l'MVP — app in primo piano, programma MFi
          di Apple per il Bluetooth classico, un dialetto di comandi per marca.
          Le comande escono dalle stampanti che interrogano il server, i
          documenti dal browser della postazione. */}
