...
const PHOTO_BY_TONE = {
  a: 'u_11', // photo-1414235077428...?w=600
  b: 'u_7',  // photo-1517248135467...?w=600
  c: 'u_8',  // photo-1551024709...?w=600
  d: 'u_9',  // photo-1546069901...?w=600
  e: 'u_11',
};
function Photo({ src, label, tone = 'a' }) {
  const fallbackId = PHOTO_BY_TONE[tone] || PHOTO_BY_TONE.a;
  const url = src || window.__R(fallbackId);
  return (
    <div style={{
