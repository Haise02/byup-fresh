    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            marginTop: 20, fontSize: 15, color: 'rgba(255, 255, 255, 0.65)',
  ...
  return (
    <div style={{marginBottom: 16}}>
      <label htmlFor={id} style={{
        display: 'block', fontSize: 15, fontWeight: 500, color: T.label,
      ...
      <div style={{
        ...
        <input
          ...
          style={{
            ...
            background: 'transparent', fontSize: 18, fontWeight: 400,
      ...
      {invalid && errorText && (
        <div style={{fontSize: 14, color: T.errColor, marginTop: 6, lineHeight: 1.4, fontWeight: 500}}>
          {errorText}
        </div>
      )}
    </div>
  ...
  return (
    <button
      ...
      style={{
        ...
        fontSize: 16, fontWeight: 500, color: T.color,
