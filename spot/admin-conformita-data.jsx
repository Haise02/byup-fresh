...
const FORNITORI = [
  { id:'F01', nome:'Stripe', servizio:'Pagamenti, Connect, Terminal, Billing',
    dati:'Dati di pagamento dei clienti finali e dei locali',
    dpa:true, dpaFirmatoIl:new Date('2024-03-12'),
    certificazioni:['PCI DSS L1','SOC 2 Type II'], paese:'Irlanda · UE',
  ...
  { id:'F02', nome:'Amazon Web Services', servizio:'Infrastruttura (Fargate, RDS, S3)',
    dati:'Tutti i dati della piattaforma a riposo e in transito',
    dpa:true, dpaFirmatoIl:new Date('2023-09-05'),
    certificazioni:['ISO 27001','SOC 2 Type II','ISO 27018'], paese:'Irlanda · UE (eu-central-1)',
    ultimoRiesame:new Date('2025-11-18'), esito:'confermato',
    doc:'Drive · Fornitori/AWS/DPA-2025.pdf' },
  { id:'F03', nome:'OpenAPI', servizio:'Trasmissione fiscale, validazione dati aziendali',
    dati:'Dati fiscali dei locali, credenziali AdE',
    dpa:true, dpaFirmatoIl:new Date('2024-06-20'),
    certificazioni:['ISO 27001'], paese:'Italia',
    ultimoRiesame:new Date('2025-11-18'), esito:'confermato',
    doc:'Drive · Fornitori/OpenAPI/DPA-2025.pdf' },
  { id:'F04', nome:'Anthropic', servizio:'Elaborazione AI dei menu in onboarding',
    dati:'Contenuto dei menu caricati dai locali (nessun dato personale)',
    dpa:true, dpaFirmatoIl:new Date('2026-01-15'),
    certificazioni:['SOC 2 Type II'], paese:'USA · SCC',
  ...
  { id:'F05', nome:'Google Maps Platform', servizio:'Discovery e geolocalizzazione locali',
    dati:'Coordinate approssimate degli utenti app',
    dpa:true, dpaFirmatoIl:new Date('2024-02-08'),
    certificazioni:['ISO 27001','SOC 2 Type II'], paese:'USA · SCC',
    ultimoRiesame:new Date('2025-11-18'), esito:'confermato',
    doc:'Drive · Fornitori/Google/DPA-2025.pdf' },
  { id:'F06', nome:'Vercel', servizio:'Hosting dei prototipi e delle superfici statiche',
    dati:'Nessun dato personale in produzione',
    dpa:false, dpaFirmatoIl:null,
    certificazioni:['SOC 2 Type II'], paese:'USA · SCC',
    ultimoRiesame:null, esito:null,
    doc:null },
  { id:'F07', nome:'Firebase Cloud Messaging / APNs', servizio:'Notifiche push',
    dati:'Token dispositivo degli utenti app',
    dpa:true, dpaFirmatoIl:new Date('2024-02-08'),
    certificazioni:['ISO 27001'], paese:'USA · SCC',
    ultimoRiesame:new Date('2025-11-18'), esito:'confermato',
    doc:'Drive · Fornitori/Google/DPA-2025.pdf' },
];
