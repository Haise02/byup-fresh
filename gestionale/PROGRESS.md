...
**5 set — la configurazione completa è ancora onboarding, e «Scarica Byup Staff» ne esce.** Le due fasce di attivazione — «Collega Stripe per incassare» e «Collega i dati fiscali all'Agenzia» — **escono dalla Configurazione completa**: ieri sera erano state messe in tutti e tre i punti d'arrivo, ma quella pagina non è un arrivo — ci si entra solo dallo step 4 dell'onboarding e da lì si esce nel gestionale. Chiedere Stripe e il fiscale mentre il locale sta ancora mettendo in piedi vetrina e personale è lo stesso muro sulla porta che il 4 settembre (D-105) si era tolto dall'onboarding, rimesso due schermate più in là. Le fasce restano dove si atterra **davvero**: **Panoramica** per chi dall'onboarding rapido va dritto nel gestionale, **Profilo → Piani** per chi conclude la configurazione completa. Chi dal rapido passa al completo non le vede: è ancora onboarding.

Nella stessa rail sparisce anche la tessera **«Scarica Byup Staff»**, che lì dentro **non si vedeva**: sopra c'è «Membri e dispositivi», che con un team di otto righe riempie la colonna da sola, e la tessera finiva sotto il taglio dello scroll — di lei si intravedevano il titolo e mezza riga, la mascotte mai. Rimpicciolirla non avrebbe risolto: quello che la nasconde è la lista sopra, che cresce col team. Non è una perdita, perché la tessera era **già uscita dall'onboarding** il 4 settembre per una ragione — chiedere di portarsi via l'app mentre il locale sta ancora mettendo in piedi vetrina e personale è prematuro — e rimetterla in questa rail era la stessa domanda fatta due schermate più in là. Resta dov'è a casa: **Impostazioni → Personale**, accanto a chi collega un dispositivo, e lì il riquadro non si tocca.

Sempre in quella rail, **«Membri e dispositivi» dimagrisce**: erano otto righe — tre persone più due stampanti e tre monitor, perché alla riga di partenza si sommavano tutti i dispositivi che il registro del locale d'esempio aveva già — e sotto, «Come creare un membro del team?» finiva a filo del taglio. Ora la riga di partenza porta **un monitor e una stampante**, e la sincronizzazione col registro aggiunge **solo quello che si collega da lì**: la fotografia di ciò che il registro aveva all'apertura del passo non entra in elenco. Cinque righe, il link si legge senza scorrere, e collegare una stampante o approvare un monitor lo fa comparire come prima. Nell'elenco la **stampante prende il segno del foglio**: fino a ieri ogni dispositivo aveva l'icona del monitor, e una stampante disegnata come uno schermo.
