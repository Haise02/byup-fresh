...
const PN_SEARCH_INDEX = [
  ...
  { g:'Azioni rapide', label:'In caso di controllo',    sub:'Contabilità · dove mostrare gli scontrini trasmessi', href:'byup Contabilita.html?controllo=1', keys:'controllo verifica verificatore ispezione guardia di finanza agenzia entrate portale fisconline corrispettivi invii giornalieri prova scontrini' },
