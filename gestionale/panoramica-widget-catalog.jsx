...
const PN_WIDGET_CATALOG = [
  ...
  // 2×4: doppia colonna — la chat ci guadagna riga e respiro — e alto quanto
  // la prima fascia che gli sta di fianco (Incassi + Stato tavoli + l'attacco
  // di Recensioni/Cucina), senza scendere da solo oltre il resto.
  { id: 'byuppino', name: 'Byuppino AI', desc: 'Chiedi in italiano: prenotazioni, menù, sala, impostazioni', component: 'WidgetByuppino', size: { w: 2, h: 4 }, pin: 'end', category: 'Utilità', icon: 'sparkles' },
