        ...
        <div style={{
          ...
          <div style={{flex:1, minWidth:0}}>
            ...
            <div style={{
              ...
              fontSize: 13, fontWeight: 600, marginBottom: 10, letterSpacing: 0.4,
            }}>
              <span style={{
            ...
            <h1 style={{
              fontWeight: 600,
              fontSize: 32, margin: '0 0 6px', letterSpacing: '-0.02em', color: PN.TEXT,
            }}>
              Completa la tua presenza su byup.
            </h1>
            <p style={{fontSize: 15.5, color: PN.MUTED, margin: 0, maxWidth: 680, lineHeight: 1.5}}>
          ...
          <div style={{display:'flex', gap:10, flexShrink:0}}>
            ...
            <a href="byup Panoramica.html" style={{
              ...
              borderRadius: 9,
              fontSize: 15, fontWeight: 600, color: PN.TEXT,
              textDecoration: 'none',
  ...
  return (
    <button onClick={onClick} style={{
      ...
      <div style={{textAlign:'left'}}>
        <div style={{fontSize:15, fontWeight:700, color: tone}}>{label}</div>
        <div style={{fontSize:13, color: PN.MUTED, marginTop:1}}>{sub}</div>
      </div>
    </button>
  );
}
