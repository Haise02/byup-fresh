...
const SALA_TAVOLI = [
  ...
  { id: 4,  state: 'prenotato', posti: 4, ordini: [],
    ...
    nextReservation: { time: '20:30', name: 'Annie Edison', posti: 4, inMin: 12, allergens: ['nuts'], allergensDeclaredAt: '18:10', allergensDeclaredBy: 'Giulia' },
...
// ─── Prenotazioni del giorno: il seme condiviso (P-109) ─────────────────────
// Il calendario della Sala (sala-tab-calendario.jsx) lavora su QUESTO array e
// lo muta (SALA_RES_ADD/UPDATE); la Panoramica lo legge per il riquadro
// «Prenotazioni di oggi», così i due non possono più divergere. Il file va
// caricato PRIMA del calendario. Gli allergeni sono codici del dizionario
// (PN_ALLERGENI, P-24 · D-27), mai testo, mai nella nota, mai accanto al nome
// in una stringa.
const SALA_RES_SEED = [
  // Pranzo
  {id:'r1', time:'12:30', dur:90, name:'Famiglia Ferri', posti:4, table:5, status:'arrivata', phone:'+39 348 ...', note:null, source:'walkin'},
  // P-24 (D-27): gli allergeni sono i CODICI del dizionario (PN_ALLERGENI,
  // da P-109 quelli del modello: gluten, milk, nuts…), mai testo, mai nella
  // nota, mai accanto al nome in una stringa. Con loro viaggiano il momento
  // della dichiarazione (di norma la telefonata) e chi l'ha registrata —
  // traccia operativa, mai base di metriche.
  {id:'r2', time:'13:00', dur:75, name:'Martina Ciani', posti:2, table:3, status:'confermata', phone:'+39 333 ...', note:null, notes:'Seduta lontano dalla cucina', source:'tel', allergens:['nuts'], allergensDeclaredAt:'11:20', allergensDeclaredBy:'Giulia'},
  ...
  {id:'r4c', time:'14:00', dur:60, name:'Pellegrini', posti:3, table:9, status:'confermata', phone:'+39 348 ...', note:null, notes:null, source:'tel', allergens:['gluten'], allergensDeclaredAt:'09:45', allergensDeclaredBy:'Marco'},
  ...
  {id:'r5',  time:'20:30', dur:90,  name:'Andrea Bianchi',  posti:2, table:3,  status:'confermata', phone:'+39 339 12 34 567', note:null, notes:'Menu fisso concordato', source:'tel', allergens:['gluten'], allergensDeclaredAt:'17:05', allergensDeclaredBy:'Mario Rossi'},
  ...
  {id:'r6',  time:'21:30', dur:90,  name:'Famiglia Robinson',  posti:4, table:7,  status:'confermata', phone:'+39 348 22 33 444', note:null, notes:null, source:'tel', allergens:['gluten'], allergensDeclaredAt:'18:40', allergensDeclaredBy:'Giulia'},
  ...
  {id:'r29', time:'12:30', dur:120, name:'Pellegrini', posti:4, table:12,   status:'confermata', phone:'+39 333 ...', note:null, notes:null, source:'tel', allergens:['milk'], allergensDeclaredAt:'10:15', allergensDeclaredBy:'Marco'},
...
window.SALA_RES_SEED = SALA_RES_SEED;
