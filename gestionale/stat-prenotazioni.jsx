            ...
            {d.copertiGiorno.map((g, i) => {
              ...
              return (
                <div key={i} style={{display:'flex', flexDirection:'column', alignItems:'center', gap: 6}}>
                  <span style={{fontSize: 13, fontWeight: 700, color: above ? PN.GREEN : PN.PINK}}>{g.val}</span>
                  <div style={{
                  ...
                  <span style={{fontSize: 13, color: PN.MUTED, fontWeight: 600}}>{g.d}</span>
                </div>
              );
            })}
          </div>
...
function StatusRow({ label, n, pct, bg, color, big }) {
  return (
    <div style={{
      ...
      <span style={{fontSize: big ? 16 : 15, fontWeight: 700, color}}>{label}</span>
      <span style={{fontSize: big ? 18 : 15, fontWeight: 700, color, fontVariantNumeric:'tabular-nums'}}>
