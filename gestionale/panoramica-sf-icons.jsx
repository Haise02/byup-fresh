...
const SfIcons = {
  ...
  'trash': () => (
    <path fillRule="evenodd" clipRule="evenodd" d="M10 2.5A1.5 1.5 0 0 0 8.5 4v.6H4.9a1.15 1.15 0 1 0 0 2.3h14.2a1.15 1.15 0 1 0 0-2.3H15.5V4A1.5 1.5 0 0 0 14 2.5h-4ZM5.7 8.3h12.6l-.86 11.06a2.5 2.5 0 0 1-2.49 2.34H9.05a2.5 2.5 0 0 1-2.49-2.34L5.7 8.3Zm4.3 2.9a.9.9 0 0 1 .9.9v5.2a.9.9 0 1 1-1.8 0v-5.2a.9.9 0 0 1 .9-.9Zm4 0a.9.9 0 0 1 .9.9v5.2a.9.9 0 1 1-1.8 0v-5.2a.9.9 0 0 1 .9-.9Z"/>
  ),
