...
OpenAPI è il provider per la trasmissione fiscale (corrispettivi e fatture) e la validazione dei dati aziendali. Il modello fiscale del prototipo, verificato sulle fonti in `Fonti/` il 3 settembre 2026, è questo. Le forme giuridiche sono due, ditta individuale e società (chi somministra è un'impresa: il professionista non esiste nel settore, l'ente è rimandato alla Soluzione Software perché con il canale attuale richiede una configurazione dedicata del fornitore; FIPE 2026: altre forme 0,8% dei ristoranti). I corrispettivi passano dalla procedura web del documento commerciale online, che non è delegabile: per la ditta con le credenziali Fisconline del titolare, rinnovate ogni novanta giorni da lui (P-104); per la società con quelle di una persona di Byup che la società nomina una volta come incaricato col gestore incarichi del portale (specifiche corrispettivi §2.9, «operatori incaricati»), la cui password rinnova Byup da Hubble → Piattaforma → Incaricati Fisconline, per tutte le società insieme (registro `byup_incaricati`). Le fatture le trasmette e riceve OpenAPI come trasmittente accreditato allo SDI senza deleghe; il mandato è contrattuale (TC-01 art. 12); l'esercente registra sul portale il codice destinatario del canale, PIC7CPS, come proprio indirizzo telematico (atto suo, delegabile solo agli intermediari abilitati). La delega unica a Byup, ammessa anche a chi non è intermediario, è una sola con due servizi: «fatturazione elettronica e conservazione» (conservazione presso l'Agenzia, perché OpenAPI non la offre) e «accreditamento e censimento dispositivi», con cui Byup accredita oggi il locale come esercente e domani, con la Soluzione Software, censirà i punti di emissione e collegherà i POS. Il collegamento dei POS oggi lo fa l'esercente da solo, col foglio precompilato di P-105, e nasce con lo strumento, non nell'onboarding. Con la Soluzione Software (Provv. 111204/2025) spariscono le credenziali per tutti, l'accreditamento diventa un aggiornamento di registrazione fatto da Byup con la delega, e la delega resta quella, una sola.
...
Nel prototipo (P-101): il registro delle stampanti e i due layout a 80 mm vivono in `stampa.jsx`, la scheda è Impostazioni → Stampanti (modalità browser, Wi-Fi via ePOS/CloudPRNT, Bluetooth via il ponte dell'App Staff; stampante di cortesia della sede; prova di stampa), la stampa dal browser è vera (comanda dal KDS sulla sorgente selezionata, documento di cortesia dalla cassa dopo l'incasso), in Wi-Fi e Bluetooth la stessa anteprima dichiarata; instradamento via WebSocket, invio ePOS/CloudPRNT, coda e fallback non esistono senza backend e sono dichiarati finzione. La matrice di compatibilità reale si prova sul campo e si riporta nella SFA §7.
