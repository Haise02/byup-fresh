...
Il piano Gratuito (in origine "Free") funge da demo in condizioni reali. Il supporto tecnico include chat bot, tutorial e ticket via email per tutti i piani; Plus aggiunge il supporto telefonico Lun–Ven nelle fasce 12:00–16:00 e 18:00–22:00 con callback entro 2 ore; Business lo estende a H24, 7 giorni su 7, con callback entro 1 ora. Il numero di menu creabili varia da 1 (Gratuito) a 3 (Starter) a illimitati (Plus e Business), e allo stesso modo i membri dello staff: 1, fino a 3, illimitati. **Byup AI** — l'assistente che si chiede in italiano e che agisce sul gestionale (Byuppino in Panoramica, il pulsante nelle schermate) — è incluso in **Plus e Business**: lo dicono le tessere dei due piani e una riga sua nel confronto, e chi scende al Gratuito se lo vede elencare fra le cose che perde. In Impostazioni → Personale sta **chi entra** nel gestionale: le persone, il **monitor di cucina** — che entra come loro, con una sua vista — e i telefoni di Byup Staff. Le **stampanti non ci stanno più** (P-134): una stampante non entra da nessuna parte, riceve fogli e li stampa; vive in Impostazioni → **Integrazioni**.
...
**Gli stati del conto collegato sono quattro, e sono i quattro di Stripe** (`restaurants.stripe_connect_status`, P-130): `pending` (aperto, verifica non finita), `active`, `restricted` (Stripe ha limitato il conto: manca qualcosa e finché non arriva blocca qualcosa) e `disabled`. Il **conto limitato** è la situazione più frequente nella realtà — Stripe apre, il locale comincia a lavorare, e dopo qualche giorno chiede un documento in più — e non diventa una schermata da compilare: **i documenti che Stripe chiede al ristoratore non li raccogliamo e non li conserviamo noi, mai**, ed è anche la ragione per cui del conto il modello conserva soltanto l'identificativo e lo stato. Quindi è una fascia informativa più un pulsante che porta su Stripe. La fascia dice la **conseguenza** nella lingua del ristoratore, perché «limitato» non vuol dire una cosa sola: o «continui a incassare, ma i versamenti sono fermi», o «non puoi più incassare con la carta». Quale delle due sia in corso lo sa solo Stripe, si chiede sul momento e **non si salva**: un dato salvato diventerebbe una bugia il giorno dopo.

OpenAPI è il provider per la trasmissione fiscale (corrispettivi e fatture) e la validazione dei dati aziendali. Nel prototipo **non ha una tessera in Integrazioni**: un catalogo è il posto dove si sceglie, e sul canale non c'è niente da scegliere — è uno solo, incluso nell'abbonamento (D-38), non si collega e non si scollega. Chi trasmette si legge in Dati fiscali, dove vivono credenziali, delega, POS e codice destinatario. Il modello fiscale del prototipo, verificato sulle fonti e rivisto il 4 settembre 2026 con D-103, è questo. Le forme giuridiche sono **tre**: ditta individuale, società, ente o altra forma collettiva. Il professionista non esiste — chi somministra alimenti esercita un'impresa (art. 4 DPR 633/72, art. 2195 c.c.) e il rapporto FIPE 2026 non conosce la categoria: le imprese del settore sono individuali (46,5%), società di capitale (29,1%), società di persone (23,3%) e altre forme collettive (circa 1%). L'ente non è più rimandato alla Soluzione Software: ha i campi della società e nessun percorso proprio.
...
L'autenticazione segue flussi distinti per tipologia di utente: lo staff accede con email e password (2FA disponibile), i consumer con email/password o social login (Google, Apple), e il team admin con 2FA obbligatorio.

Il **monitor di cucina** non ha più nome utente e password (P-134): si collega **con un codice che il titolare approva**. Chi è in cucina accende lo schermo e apre un indirizzo corto e dedicato, `byup.it/cucina` — non quello del gestionale, perché su un televisore si scrive col telecomando e ogni carattere in più è un errore in più — e lo schermo mostra un QR con sotto lo stesso codice in chiaro. Il QR per chi passa col telefono, il codice per chi in quel momento è alla cassa; il QR non contiene un numero da ricopiare, contiene il collegamento alla pagina di conferma col codice già dentro. Il codice **dura pochi minuti e si rigenera da solo**: uno che resta appeso in cucina tutta la sera è una porta aperta. Chi conferma — il **solo Titolare**, ed è un permesso — dà allo schermo un nome e sceglie la vista. Il collegamento **dura finché non lo si revoca**: nessuna scadenza e nessuna sessione che finisce da sola, perché lo schermo resta acceso dall'apertura alla chiusura e nessuno lo guarda per accertarsi che sia ancora collegato — lo guarda per sapere cosa cucinare. Si toglie da Personale, come si toglie l'accesso a una persona, e da lì si cambiano anche nome e visualizzazione. Non è solo una semplificazione: con la password, chiunque conoscesse `PG1-cucina` apriva la cucina di quel locale da qualunque browser del mondo, e su quello schermo passano i nomi dei tavoli e le allergie dichiarate dai clienti, che sono dati sulla salute.

Il **telefono che incassa** non si appaia a niente: l'operatore apre Byup Staff, entra con le proprie credenziali personali — le stesse del gestionale — e il telefono si registra da solo al primo accesso. Per questo la pagina delle integrazioni non ha più un «Collega un dispositivo»: prometteva un gesto che non esiste.
...
**La regola, in una riga (D-109, che rivede D-108): comande e documenti del cliente escono dalle stampanti collegate al nostro server; il browser è il ripiego, e solo per i documenti.** Fissata sulle fonti dei produttori e degli standard acquisite il 3 e 4 settembre 2026.

La **stampante collegata** — Star con CloudPRNT, Epson con Server Direct Print, sui modelli dei rispettivi elenchi — non la chiamiamo noi: è lei che ogni pochi secondi chiede al nostro server se c'è qualcosa da stampare. È l'unica via che stampa senza una persona davanti a un dispositivo, senza un dispositivo acceso nel locale e senza un terzo fra Byup e la stampante, e per questo ha la **precedenza, sempre**. La **stampa dal browser** prepara una pagina da 80 mm e la manda alla stampa di sistema: esce da qualunque stampante, di qualunque marca, ma ha tre limiti che non si aggirano — serve sempre una persona che confermi, non sappiamo quali stampanti abbia quel computer e non possiamo sceglierne una, non sappiamo se il foglio è uscito.

Per i **documenti del cliente** — pre-conto e documento di cortesia, due fogli distinti per lo stesso cliente, uno prima e uno dopo il pagamento, che quindi seguono la **stessa** strada — se la stampante collegata di quel POS non c'è o non risponde si ripiega sul browser, **e il lavoro in coda si annulla**: se restasse lì, la stampante che torna su mezz'ora dopo sputerebbe un secondo foglio per un cliente che se n'è andato. Il ripiego non è sempre possibile: serve un gestionale aperto su schermo largo o tablet, mai un telefono, e un utente con i permessi da Cassa. Se ne è aperto **uno solo**, la finestra di stampa si apre da sé; se ne sono aperti **due o più** compare una fascia leggera su tutti, e la prende chi è davvero al banco — nel momento in cui uno stampa sparisce da tutti insieme, e se non la prende nessuno sparisce da sola dopo qualche minuto. Se **nessuno** è aperto, il foglio non si può stampare e il gestionale lo dice mentre si incassa, così il cliente sente «le mando la ricevuta». Quella fascia **non lascia voce in Notifiche**: in un locale senza stampante comparirebbe a ogni pagamento con carta.

Per le **comande non esiste ripiego**: in cucina non c'è nessuno che prema Stampa. Se la stampante di cucina non risponde, la cucina lavora dal **monitor**, che vede tutte le comande, e il gestionale mostra in sala una fascia a tutta larghezza che nomina la stampante e le categorie che teneva — «Bevande, Dolci» dice esattamente che cosa non è uscito, perché una categoria sta su una stampante sola. Le comande rimaste in coda **scadono**: una comanda stampata due ore dopo fa più danno di una non stampata. La fascia se ne va in tre modi e solo tre — «Letto», una prova di stampa riuscita, o un'altra stampante che prende quelle categorie — e non compare nell'istante dell'invio: la stampante ci interroga ogni pochi secondi, quindi l'errore si scopre dopo, e la fascia nasce dallo stato della coda, non dal gesto.

**Una stampante che stampa dal browser non è un dispositivo e non si aggiunge.** Dal browser non torna indietro niente, quindi quella riga sarebbe un nome scritto a mano e tre campi vuoti per sempre. Ogni stampante in elenco è, per definizione, una che interroga il nostro server: `connection_mode` non esiste più, perché avrebbe un valore solo.

**POS e postazione non sono la stessa cosa.** Il POS è lo strumento con cui si incassa — il lettore di carte, o lo smartphone con Byup Staff — e dice **a quale cassa** sta pagando il cliente, quindi da quale stampante esce il suo foglio. La postazione è il dispositivo su cui il gestionale è aperto, cioè dove c'è un browser che può stampare. Al banco coincidono; si separano quando il cameriere incassa in sala col telefono, e lì il foglio esce al banco.
...
Nel prototipo (P-128): registro, coda, postazioni aperte, richieste di stampa, le due fasce e i tre layout a 80 mm vivono in `stampa.jsx`; la configurazione sta in **Integrazioni**, in un box con «Aggiungi stampante», e la sezione Impostazioni → Stampanti non esiste più. **Inviare un ordine accoda davvero le comande**, una per stampante, con le sole righe delle sue categorie: le righe di categorie non instradate non stampano e vivono sul monitor.

**I due fogli (4 settembre 2026).** «Aggiungi stampante» si apre subito e in cima dice la cosa che serve: l'**indirizzo del nostro server** da scrivere nella pagina di configurazione della stampante — `https://print.byup.it/cloudprnt/<sede>` per Star (CloudPRNT → Server URL), `https://print.byup.it/sdp/<sede>` per Epson (Web Config → Server Direct Print) — con il tasto che lo copia. Sotto sta l'elenco di chi si è presentato, e il **caricamento vive dentro quell'elenco**, con «Cerca di nuovo» accanto: nessuno deve guardare una schermata vuota per leggere un indirizzo che è già scritto e non cambia. Da una pagina web non esiste una scansione della rete locale e il browser non espone a JavaScript l'elenco delle stampanti di sistema: si guarda **chi ha contattato il nostro server**, e fingere altro sarebbe una promessa che il primo sabato sera si scopre falsa. **«Questa postazione» non è in elenco**: la stampa dal browser non si collega e non si scollega — c'è sempre, ed è la strada che il documento prende quando nessuna stampante collegata risponde; metterla fra le cose da aggiungere confonderebbe una via con un oggetto. Sotto le tessere sta invece **«Prova la stampa dei documenti»**, che è la prova della **strada** e non di un dispositivo: apre un foglio di esempio nella stampa di quel computer, dice se una stampante c'è e se il margine da 80 mm viene giusto, e non registra niente.

Su una stampante **nuova** la prova di stampa non è un pulsante: è il cancello. Alla conferma parte da sola, e la stampante entra in elenco **solo se risponde** — una stampante aggiunta e muta è peggio di una non aggiunta, perché il sabato sera nessuno va a cercare perché la comanda non è uscita. Sul foglio di una stampante già collegata la prova resta a portata, accanto a «Salva».
...
**Che cosa si sceglie.** Il nome (proposto dal modello, riscrivibile) e l'**uso**: comande, e allora si assegnano le categorie di tutti i menù — è l'**unico** posto dove si assegnano, da quando le stampanti sono uscite da Personale — con quelle già prese da un'altra stampante spente e col nome di chi le tiene; oppure **documenti del cliente**, e allora — solo se una seconda stampante per i documenti esiste già — si scelgono i **POS che stampano lì**, con la spunta che toglie il POS dalla stampante di prima. Con una stampante sola la domanda non si fa. Nello stesso foglio sta la casella **«Stampa da sola a incasso avvenuto»**, spenta di default.
...
**Il documento del cliente, a incasso chiuso.** Da dove esce lo decide il POS su cui si è incassato: se quel POS ha una stampante collegata, il documento ci va in coda e ne esce **diretto**, senza finestre e senza conferme — anche quando chi incassa ha in mano solo il telefono in sala, perché il foglio esce al banco. Fra il tocco e la carta passano i secondi del sondaggio della stampante, quindi finché non ha confermato la schermata dice che il foglio **sta uscendo**, non che è uscito. L'ordine è di due gradini soli: la stampante associata a **quel** POS; se non ne ha una, la sola stampante dei documenti quando ce n'è **una sola**. Con due casse e due stampanti, una cassa non ancora associata **non prende una stampante a caso** — il foglio uscirebbe dall'altra parte del locale: si stampa dal browser e si chiede di completare l'associazione. La casella nel foglio della stampante decide se il documento parte **da solo** a incasso chiuso o **al tocco**: il predefinito è al tocco, perché l'automatico stampa anche quando il cliente il foglio non lo vuole, e quelli sono fogli buttati. Con l'automatico acceso il pulsante in cassa dice che il foglio è già uscito e serve solo a ristamparlo, e resta spento mentre la stampa è in corso.

La stampa dal browser è vera; il rilevamento, lo stato «in linea» e l'esito della prova sono simulati e lo dicono. Nel prototipo lo stato di una stampante si può far cadere toccandolo sulla tessera — è finzione dichiarata dal titolo del comando — perché altrimenti la fascia della stampante muta non si potrebbe nemmeno guardare.

**Il foglio nel sacchetto degli ordini a domicilio (P-129).** Per gli ordini da piattaforma il documento di cortesia esce **in coda alla comanda**, sulla stampante di cucina e non su quella del banco, perché è lì che il sacchetto si chiude: è un'eccezione voluta alla regola dei documenti, e va scritta, altrimenti qualcuno un giorno la «corregge». È un'**opzione**, una per piattaforma (un locale può volerla per Glovo e non per Deliveroo), e nasce **accesa**: un sacchetto che parte senza foglio è un errore che il cliente scopre a casa, e nessuno va ad accendere un'impostazione di cui ignora l'esistenza. Si spegne perché chi stampa già l'etichetta della piattaforma si ritroverebbe due fogli nello stesso sacchetto. **Senza una stampante di cucina collegata la casella si vede ma è spenta e non si può accendere**: all'arrivo dell'ordine nessuno sta guardando la finestra di stampa del browser.

Stampanti e monitor cucina si instradano in modo diverso, perché sono oggetti diversi. La stampante è cieca e irreversibile: al collegamento le si assegnano le categorie che deve stampare, e una categoria non può essere assegnata a due stampanti — l'instradamento è uno solo (`category_routings`), e da P-134 si scrive **da un posto solo**, il foglio della stampante in Integrazioni. Il monitor cucina non riceve categorie e non le riceverà: vede tutte le comande, e chi ci lavora restringe con i filtri Canali e Categorie nella testata della schermata Cucina — le categorie sono una cosa delle stampanti. Con più monitor, tutti vedono tutto e ciascuno filtra per conto proprio.
