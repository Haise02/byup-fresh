...
Nel prototipo (P-124): registro, coda e i tre layout a 80 mm vivono in `stampa.jsx`; la configurazione sta in **POS e integrazioni**, col popup «Collega stampante» (marca e modello, indirizzo del nostro server e chiave da copiare sulla stampante, attesa del primo contatto, categorie da instradare, prova di stampa), e la sezione Impostazioni → Stampanti non esiste più. La stampa dal browser è vera; il primo contatto della stampante, lo stato «in linea» e l'esito della prova sono simulati e lo dicono. La stampa automatica del documento di cortesia per gli ordini da piattaforma è riscritta come documento in coda alla comanda sulla stampante di cucina: dal browser non può avvenire, perché la stampa dal browser vuole una persona.
