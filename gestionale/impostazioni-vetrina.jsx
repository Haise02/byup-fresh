...
// Riga FAQ: tutta cliccabile per modificare — in hover si ingrandisce e si
// evidenzia, alla pressione si comprime. A destra solo il cestino rosso.
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: 'transform 160ms cubic-bezier(0.34, 1.45, 0.64, 1), border-color 140ms ease, background 140ms ease, box-shadow 160ms ease, opacity 120ms ease',
      }}>
