      ...
      >
        ...
        <div style={{flex: 1, minWidth: 0}}>
          <div style={{display:'flex', alignItems:'center', gap: 7, marginBottom: 3}}>
            <span
              style={{fontSize: 14.5, fontWeight: 700, position:'relative', cursor:'default'}}
              onMouseEnter={e => {
            ...
            >
              ...
              <span className="role-tip" style={{
                ...
                <div style={{fontWeight: 700, marginBottom: 6, fontSize: 11.5, opacity: 0.7, textTransform:'uppercase', letterSpacing: 0.4}}>Aree accessibili</div>
            ...
            {role.locked && <span style={{fontSize: 11}}>🔒</span>}
          </div>
          <div style={{fontSize: 12, color: PN.MUTED, lineHeight: 1.4}}>
            {role.desc}
          </div>
        </div>
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{flex: 1, minWidth: 0}}>
          <div style={{display:'flex', alignItems:'center', gap: 7, marginBottom: 3}}>
            <span style={{fontSize: 14.5, fontWeight: 700}}>Dispositivi</span>
            <span style={{
              fontSize: 11.5, fontWeight: 600,
              color: count === 0 ? PN.MUTED : PN.TEXT,
              opacity: count === 0 ? 0.55 : 1,
                  ...
                  return (
                    <label key={r.id} style={{
                      ...
                      <div style={{flex: 1}}>
                        ...
                        <div style={{fontSize: 11.5, color: PN.MUTED, marginTop: 1, marginBottom: 6}}>{r.desc}</div>
                        <div style={{display:'flex', flexWrap:'wrap', gap: 4}}>
                    ...
                    <span style={{display:'inline-flex', alignItems:'center', gap: 10}}>
                      ...
                      <span style={{display:'flex', flexDirection:'column', alignItems:'flex-start', gap:1}}>
                        ...
                        {isPrinter && selectedPrinter && (
                          <span style={{fontSize:11, color:PN.MUTED}}>{selectedPrinter.ip}</span>
                        )}
                      </span>
                    </span>
                    ...
                    <div style={{
                      ...
                      {DEVICE_TYPES.map(t => (
                        <button key={t.id} onClick={() => { setDeviceTypeId(t.id); setOpenTypeMenu(false); }}
                          ...
                          <div>
                            <div style={{fontSize:13, fontWeight:600, color: deviceTypeId === t.id ? PN.PINK_DARK : PN.TEXT}}>
                              Tablet/iPad/Schermo
                            </div>
                            <div style={{fontSize:11.5, color:PN.MUTED}}>Monitor cucina</div>
                          </div>
                        </button>
                      ))}
                      ...
                      {AVAILABLE_PRINTERS.map(p => (
                        <button key={p.id} onClick={() => { setDeviceTypeId(p.id); setOpenTypeMenu(false); }}
                          ...
                          <div>
                            <div style={{fontSize:13, fontWeight:600, color: deviceTypeId === p.id ? PN.PINK_DARK : PN.TEXT}}>
                              Stampante ({p.model})
                            </div>
                            <div style={{fontSize:11.5, color:PN.MUTED}}>{p.ip}</div>
                          </div>
                        </button>
                      ))}
                    </div>
              ...
              {deviceType.noCredentials && (
                <div style={{marginBottom: 16}}>
                  <div style={{display:'flex', alignItems:'baseline', justifyContent:'space-between', marginBottom: 4}}>
                    <div style={{fontSize: 12.5, fontWeight: 700}}>Categorie stampate</div>
                    <button onClick={() => {
                        ...
                        <div key={m.id} style={{
                          ...
                          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom: 8}}>
                            <div style={{display:'flex', alignItems:'center', gap: 8}}>
                              <span style={{fontSize: 12.5, fontWeight: 700, color: PN.TEXT}}>{m.label}</span>
                              {menuSelectedCount > 0 && (
                                <span style={{
  ...
  return (
    <div style={{
      ...
      <div style={{flex: 1, minWidth: 0}}>
        ...
        {isPrinter
          ? <div style={{fontSize: 12, color: PN.MUTED, fontFamily:'ui-monospace, Menlo, monospace'}}>{d.ip}</div>
      ...
      {confirmScollega && (
        <div onClick={() => setConfirmScollega(false)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{fontSize: 16, fontWeight: 700, color: PN.TEXT, marginBottom: 8}}>
              Scollega dispositivo
            </div>
            <div style={{fontSize: 13.5, color: PN.MUTED, lineHeight: 1.55, marginBottom: 22}}>
  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{padding:'20px 24px', borderBottom:`1px solid ${PN.BORDER_SOFT}`}}>
          <div style={{fontSize: 17, fontWeight: 800, marginBottom: 3}}>Inviti pendenti</div>
          <div style={{fontSize: 12.5, color: PN.MUTED}}>
            {PENDING.length === 0
        ...
        <div style={{padding:'20px 24px', overflow:'auto', flex: 1}}>
          {PENDING.length === 0 ? (
            <div style={{padding: 30, textAlign:'center', color: PN.MUTED, fontSize: 13}}>
                ...
                {PENDING.map((p, i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <ImpButton variant="ghost" style={{padding:'6px 10px', fontSize: 12}}>Invita di nuovo</ImpButton>
                      <button style={{
                        padding:'6px 10px',
