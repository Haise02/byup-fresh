...
const CONTI_MOCK = [
  ...
  { id:'cnt-23', idOrdine:'#2511-0025', dataOra:'2025-11-07 21:30', tavolo:'Tav.10', cliente:'Tavolata Conti (6 ospiti)', liberatoOre:168, totaleConto:267.00, daSaldare:0.00, stato:'saldato', metodoPagamento:'contanti',
    payments: [
    ...
    <React.Fragment>
      ...
      {done ? (
        <div style={{flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:30}}>
          ...
          <div style={{fontSize:22, fontWeight:800, color:'#0F1115', marginBottom:4}}>Pagamento incassato</div>
          <div style={{fontSize:26, fontWeight:800, color:'#0F1115', marginBottom:8, letterSpacing:-0.5, fontVariantNumeric:'tabular-nums'}}>€{total.toFixed(2)}</div>
          <div style={{fontSize:13, color:'#6B7280', marginBottom:24}}>
            {conto.tavolo} · {method === 'contanti' ? 'Contanti' : 'Carta'}
          </div>
          <button onClick={onClose} style={{padding:'11px 24px', background:'#0F1115', color:'#fff', border:'none', borderRadius:8, fontSize:13, fontWeight:700, cursor:'pointer', fontFamily:'inherit'}}>
            Chiudi
          </button>
        </div>
      ) : (
        ...
        <div style={{padding:'14px 20px', borderBottom:'1px solid #F0F2F5', display:'flex', alignItems:'center', gap:12, flexShrink:0}}>
          <div style={{flex:1}}>
            <div style={{fontSize:10.5, color:'#6B7280', fontWeight:800, letterSpacing:0.6, textTransform:'uppercase'}}>Salda conto</div>
            <div style={{fontSize:18, fontWeight:800, color:'#0F1115', marginTop:1}}>
        ...
        <div style={{flex:1, display:'flex', minHeight:0, overflow:'hidden'}}>
          ...
          <div style={{flex:'1.5 1 0', display:'flex', flexDirection:'column', borderRight:'1px solid #F0F2F5', minWidth:0, overflowY:'auto', padding:'16px 20px'}}>
            <div style={{fontSize:10, fontWeight:800, color:'#6B7280', letterSpacing:0.6, textTransform:'uppercase', marginBottom:10}}>Voci</div>
            <div style={{display:'flex', alignItems:'center', gap:10, padding:'12px 14px', borderRadius:10, background:'#F9FAFB', border:'1.5px solid #E5E7EB'}}>
              <div style={{flex:1}}>
                <div style={{fontSize:13, fontWeight:700, color:'#0F1115'}}>Saldo conto</div>
                {hasPartial && (
              ...
              <div style={{fontSize:16, fontWeight:800, color:'#0F1115', fontVariantNumeric:'tabular-nums'}}>
                €{total.toFixed(2)}
              </div>
            </div>
          </div>
          ...
          <div style={{flex:'1 1 0', display:'flex', flexDirection:'column', minWidth:0, overflowY:'auto', padding:'16px 20px', gap:16}}>
            {/* Riepilogo */}
            <div style={{display:'flex', justifyContent:'space-between', fontSize:13, fontWeight:700, color:'#0F1115', padding:'10px 14px', background:'#F9FAFB', borderRadius:10}}>
            ...
            {/* Metodo */}
            <div>
              <div style={{fontSize:10, fontWeight:800, color:'#6B7280', letterSpacing:0.6, textTransform:'uppercase', marginBottom:8}}>Metodo</div>
              ...
              {method === 'contanti' && (
                <div>
                  <div style={{fontSize:11, fontWeight:700, color:'#6B7280', marginBottom:6}}>Importo ricevuto</div>
                  <div style={{display:'flex', alignItems:'baseline', gap:4, background:'#fff', border:'1.5px solid #E5E7EB', borderRadius:10, padding:'12px 14px', marginBottom:8}}>
                    ...
                    <input type="number" value={cash} onChange={e => setCash(e.target.value)}
                      ...
                      style={{border:'none', outline:'none', fontSize:22, fontWeight:800, color:'#0F1115', width:'100%', padding:0, fontFamily:'inherit', background:'transparent', fontVariantNumeric:'tabular-nums'}}/>
                  </div>
              ...
              {method === 'carta' && (
                <div style={{padding:'20px 16px', borderRadius:12, background:'#fff', border:'1.5px dashed #D1D5DB', textAlign:'center'}}>
                  ...
                  <div style={{fontSize:13, fontWeight:700, color:'#0F1115', marginBottom:4}}>Inserisci la carta nel POS</div>
                  <div style={{fontSize:24, fontWeight:800, color:'#0F1115', letterSpacing:-0.4, fontVariantNumeric:'tabular-nums'}}>€{total.toFixed(2)}</div>
                </div>
              )}

              {method === 'byup' && (
                <div style={{padding:'20px 16px', borderRadius:12, background:'#F5F3FF', border:'1.5px solid #DDD6FE', textAlign:'center'}}>
                  <div style={{fontSize:13, fontWeight:700, color:'#6D28D9', marginBottom:4}}>Pagamento via app byup</div>
                  <div style={{fontSize:24, fontWeight:800, color:'#6D28D9', letterSpacing:-0.4, fontVariantNumeric:'tabular-nums'}}>€{total.toFixed(2)}</div>
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{padding:'14px 20px', borderTop:'1px solid #F0F2F5', display:'flex', gap:10, flexShrink:0}}>
          <button onClick={onClose} style={{flex:1, padding:'11px 16px', background:'#fff', border:'1px solid #E5E7EB', borderRadius:8, fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:'inherit'}}>
            Annulla
          </button>
          <button
      ...
      <div style={{
        ...
        <div style={{padding:'18px 22px 4px'}}>
          ...
          <div style={{
            ...
            <span style={{fontSize:20, fontWeight:700, color: PN.MUTED}}>€</span>
            <input
              ...
              style={{
                ...
                fontSize:24, fontWeight:800, color: PN.TEXT, fontFamily:'inherit',
...
function ContConti({ filter = 'all', cassaOpen = false, setCassaOpen }) {
