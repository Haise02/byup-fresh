...
const SUP_FAQS = [
  ...
  // I ruoli sono quelli veri del gestionale (P-192): titolare, cameriere e
  // cassa, più quelli che il locale si crea da sé. «Admin», «Cuoco» e «Sola
  // lettura» non esistono da nessuna parte.
  { id:'f3', cat:'account', q:'Come aggiungo membri del mio staff?', a:'Vai in Impostazioni → Personale e clicca "Invita membro". Scegli il ruolo — titolare, cameriere, cassa, o uno dei ruoli personalizzati che hai creato — e invia l\'invito via email. Il nuovo membro avrà accesso solo alle sezioni concesse dal suo ruolo.' },
  { id:'f4', cat:'generale', q:'Posso gestire più locali con un solo account?', a:'Sì: ogni locale ha la sua vetrina pubblica, il suo menù e le sue statistiche. Dal tuo account puoi creare un nuovo locale oppure collegarne uno già presente su byup inviando una richiesta al titolare.' },
  // La conferma è automatica (P-192): non c'è una finestra di trenta minuti in
  // cui lo staff decide, e il promemoria al cliente è uno solo.
  { id:'f5', cat:'menu', q:'Come funziona il sistema di prenotazioni?', a:'Le prenotazioni arrivano in tempo reale dalla vetrina e dall\'app cliente, e sono confermate automaticamente: non devi approvarle una per una. Le vedi in Sala & Prenotazioni → Calendario, dove puoi spostarle o annullarle. byup manda al cliente un promemoria un\'ora prima.' },
