...
const CUC_TICKETS_ATTIVI = [
  ...
  { id: 'a4', kind: 'asporto', delivery_mode: 'asporto', customer: 'Anna Bianchi', pickup: '15:10', orderN: '#1235', time: '14:48', station: 'Pizza', items: [
  ...
  { id: 'a2', kind: 'sala', delivery_mode: 'al_tavolo', table: 12, orderN: '#1234', time: '14:50', station: 'Primi',  items: [
  ...
  { id: 'a3', kind: 'sala', delivery_mode: 'al_tavolo', table: 15, orderN: '#9101', time: '14:54', station: 'Primi',  items: [
  ...
  { id: 'a5', kind: 'delivery', delivery_mode: 'consegna', partner: 'ubereats', customer: 'Sara Rossi', pickup: '15:20', orderN: '#1239', time: '14:52', station: 'Secondi', items: [
...
const CUC_TICKETS_PREP = [
  { id: 'p1', kind: 'sala', delivery_mode: 'al_tavolo', table: 8,  orderN: '#1230', time: '14:35', station: 'Primi',  items: [
  ...
  { id: 'p2', kind: 'sala', delivery_mode: 'al_tavolo', table: 4,  orderN: '#1228', time: '14:42', station: 'Pizza',  items: [
  ...
  { id: 'p4', kind: 'delivery', delivery_mode: 'consegna', partner: 'glovo', customer: 'Luca Verdi', pickup: '15:05', orderN: '#1236', time: '14:38', station: 'Primi', items: [
  ...
  { id: 'p5', kind: 'sala', delivery_mode: 'al_tavolo', table: 6,  orderN: '#1224', time: '14:30', station: 'Primi',  items: [
  ...
  { id: 'p3', kind: 'sala', delivery_mode: 'al_tavolo', table: 11, orderN: '#1226', time: '14:45', station: 'Secondi', items: [
