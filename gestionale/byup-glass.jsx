...
// Caricare DOPO panoramica-tokens.jsx (PN) in qualsiasi pagina che voglia usare il sistema.
//
...
/* float-soft: oscillazione verticale impercettibile per icone in card "hero". */
...
@media (prefers-reduced-motion: reduce) {
  ...
  .glass-float-soft { animation: none !important; }
...
function GlassMeshSubstrate({ tone }) {
