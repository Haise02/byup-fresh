      ...
      <div style={{
        ...
        <div style={{flex: 1, minWidth: 0}}>
          <div style={{display:'flex', alignItems:'center', gap: 8, marginBottom: 3}}>
            <span style={{fontSize: 17, fontWeight: 800, color: PN.TEXT}}>Byup Staff</span>
          </div>
...
function PrinterCard({ item }) {
  ...
  return (
    <div style={{
      ...
      <div style={{flex:1, minWidth:0}}>
        <div style={{fontSize:13.5, fontWeight:700, marginBottom:2}}>{item.name}</div>
        <div style={{fontSize:11.5, color:PN.MUTED, marginBottom:7}}>{item.desc}</div>
        <div style={{display:'flex', alignItems:'center', gap:6, flexWrap:'wrap'}}>
          <span style={{fontSize:11, color:PN.MUTED, fontWeight:500, marginRight:2}}>Connessione:</span>
          {conns.map(c => {
      ...
      <div style={{display:'flex', flexDirection:'column', alignItems:'flex-end', gap:6, flexShrink:0}}>
        <div style={{display:'inline-flex', alignItems:'center', gap:5, fontSize:11, fontWeight:600, color:s.color}}>
        ...
        {linked ? (
          <ImpButton variant="ghost" style={{padding:'6px 12px', fontSize:12}}
          ...
          <ImpButton
            ...
            style={{padding:'6px 14px', fontSize:12, opacity: conn ? 1 : 0.55}}
