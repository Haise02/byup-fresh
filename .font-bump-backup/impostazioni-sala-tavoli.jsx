              ...
              return (
                <div key={s.id} style={{position:'relative'}}>
                  ...
                  >
                    ...
                    <div style={{fontSize:11.5, color:PN.MUTED, display:'flex', alignItems:'center', gap:6}}>
                      {sCount > 0 ? (
                        <>
                    ...
                    {isDragOver && (
                      <div style={{
                        ...
                        fontSize: 12, fontWeight: 800, color: PN.PINK_DARK,
                    ...
                    {bulkMoveOpen && (() => {
                      ...
                      return (
                        <div style={{
                          ...
                          <div style={{padding:'6px 10px 4px', fontSize:10.5, fontWeight:700, color: PN.MUTED, letterSpacing:0.4, textTransform:'uppercase'}}>
                            Sposta {selected.size} {selected.size === 1 ? 'tavolo in' : 'tavoli in'}
                          </div>
                          {otherSale.length === 0 ? (
                            <div style={{padding:'8px 10px', fontSize:11.5, color: PN.MUTED, fontStyle:'italic'}}>
                            ...
                            <button
                              ...
                              style={{
                                ...
                                borderRadius:6, color: PN.TEXT, fontSize:13, fontWeight:600,
              ...
              {visible.length === 0 ? (
                isFiltering ? (
                  <div style={{padding: '50px 20px', textAlign:'center', border:`1.5px dashed ${PN.BORDER}`, borderRadius: 12, background:'#FAFBFC'}}>
                    ...
                    <div style={{fontSize: 15, fontWeight: 700, marginBottom: 6}}>Nessun tavolo trovato</div>
                    <div style={{fontSize: 12.5, color: PN.MUTED, marginBottom: 16}}>Prova a modificare i filtri.</div>
                  ...
                  <div style={{padding: '60px 20px', textAlign:'center'}}>
                    ...
                    <div style={{fontSize: 14, fontWeight: 600, color: PN.MUTED, marginBottom: 16}}>Nessun tavolo in questa sala</div>
                    <ImpButton variant="primary" icon={<PnI.Plus size={13}/>} onClick={() => {
                      const center = { x: 4, y: 2.5 };
                      const newId = Math.max(0, ...tavoli.map(x => x.id)) + 1;
                      setTavoli(prev => [...prev, { id: newId, name: nextGlobalTavoloName(sale), alias: '', coperti: 4, shape: 'square', disabled: false, pos: center }]);
  ...
  return (
    ...
    >
                ...
                {otherSale.length === 0 ? (
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor:'pointer', fontFamily:'inherit', textAlign:'left',
                      borderRadius:6, color: PN.TEXT, fontSize:12.5, fontWeight:600,
                      transition:'background .12s',
                      animation: `tcSubItemIn .22s ${i * 30}ms both cubic-bezier(.2,.8,.2,1)`,
                    }}
                    onMouseEnter={e => e.currentTarget.style.background = PN.PINK_SOFT}
      ...
      <div style={{display:'flex', alignItems:'center', gap: 12}}>
        {/* Posti stepper */}
        <div style={{flex: 1}}>
          <div style={{fontSize: 10.5, fontWeight: 700, color: PN.MUTED, letterSpacing: 0.4, textTransform:'uppercase', marginBottom: 4}}>Posti</div>
        ...
        <div style={{padding:'18px 20px'}}>
          {groupInfo && (
            <div style={{
              ...
              <div style={{flex: 1}}>
                <div style={{fontSize: 12, fontWeight: 700, color: PN.PINK_DARK}}>Parte dell'unione {unionLabel}</div>
                <div style={{fontSize: 11.5, color: PN.MUTED, marginTop: 2}}>Clicca per rimuovere solo questo tavolo</div>
              </div>
              <button
          ...
          <ImpField label="Nome">
            <div style={{
              ...
              fontSize:13.5, fontFamily:'inherit', background:'#FAFBFC', color: PN.TEXT,
              display:'flex', alignItems:'center', gap:8,
            }}>
              <span style={{flex:1, fontWeight:700}}>{tavolo.name}</span>
              <span style={{fontSize:11, color: PN.MUTED, fontStyle:'italic'}}>assegnato automaticamente</span>
            </div>
          </ImpField>

          <div style={{fontSize: 12, fontWeight: 700, color: PN.MUTED, letterSpacing: 0.4, textTransform:'uppercase', marginBottom: 8}}>Posti</div>
          {(() => {
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        cursor:'pointer', fontSize: 15, color: PN.PINK_DARK,
                        fontFamily:'inherit',
                      }}
                    >−</button>
                    <input
          ...
          {isNew && (
            <div style={{
              ...
              <div style={{flex: 1, minWidth: 0}}>
                <div style={{fontSize: 13, fontWeight: 700, color: PN.TEXT, marginBottom: 2}}>Quanti tavoli creare</div>
                <div style={{fontSize: 11.5, color: PN.MUTED, lineHeight: 1.4}}>Tutti con {tavolo.coperti} {tavolo.coperti === 1 ? 'posto' : 'posti'}, nomi assegnati automaticamente</div>
              </div>
              <div style={{display:'inline-flex', alignItems:'center', border:`1px solid ${PN.BORDER}`, borderRadius: 8, overflow:'hidden', flexShrink: 0}}>
                <button onClick={() => setQuantity(q => Math.max(1, q - 1))} disabled={quantity <= 1} style={{
                  ...
                  fontSize: 16, color: PN.TEXT, fontFamily:'inherit',
                }}>−</button>
                <span style={{
          ...
          {data.tavoli.slice(0, 6).map(t => (
            <div key={t.id} style={{padding: 14, border: `1px solid ${PN.BORDER_SOFT}`, borderRadius: 12, textAlign:'center'}}>
              ...
              <div
                ...
                style={{fontSize: 11, color: PN.MUTED, marginTop: 8, display:'inline-flex', alignItems:'center', gap:3}}
              >
          ...
          <div style={{padding: 24}}>
            <div style={{
              ...
              <div style={{flex:1}}>
                ...
                <div style={{fontSize: 12, color: PN.GREEN, display:'inline-flex', alignItems:'center', gap:4, flexWrap:'wrap'}}>
