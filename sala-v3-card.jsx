      ...
      {open && (
        <div style={{
          ...
          <div style={{display:'flex', alignItems:'center', gap: 8, marginBottom: 10}}>
            ...
            <div style={{flex: 1, textAlign:'center', fontSize: 22, fontWeight: 800, color:'#0F1115', fontVariantNumeric:'tabular-nums'}}>{val}</div>
    ...
    return (
      <div style={{display:'flex', flexDirection:'column', gap: 2}}>
        ...
        <div style={{display:'flex', alignItems:'baseline', gap: 6}}>
          <span style={{fontSize: 14, fontWeight: 800, color: '#0F1115', flexShrink: 0}}>
