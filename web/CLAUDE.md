...
- **Non implementare** (di proposito): pagamento/Stripe, discovery (home/mappa/vetrine/Posta), login/registrazione, **asporto da webapp**, **geofence/GPS**.
...
- **Asporto: NON disponibile da webapp.** Il QR del menu asporto (`?takeaway=1`) mostra una schermata che porta a **scaricare l'app** (`TakeawayRedirect` in `menu.jsx`). Razionale in `Contesto-WebApp.md` §2.2.
